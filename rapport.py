...
pdf.cell(w=30, h=10, txt="  20/06/2023", ln=1)
pdf.set_font('Arial', 'B', 18)
pdf.set_text_color(r= 0, g= 0, b = 255)
pdf.cell(w=30, h=10, txt="Author: ", ln=0)
pdf.set_font('Arial', '', 13)
pdf.set_text_color(r=0, g= 0, b = 0)
pdf.cell(w=30, h=10, txt=" Firas Ben Hmida", ln=1)
pdf.ln(15)
...
pdf.image('./time_duration_histogram.png',
          x = 48, y = 140, w = 170, h = 70, type = 'PNG')
pdf.ln(90)
...
pdf.add_page()
pdf.ln(15)
pdf.multi_cell(w=0, h=10, txt='the most used mails')
pdf.ln(15)
i=0
for index, value in maill.items():
        i+=1
        line =f"{i}: {index}: {value}"
        pdf.multi_cell(0, 10, line, align="L")
i=0        
pdf.add_page()
pdf.ln(15)
